                ...
                try{
                    ...
                    for(int i= 0; i<photosJSON.length();i++){
                        ...
                        if (commentsArray != null){
                            ...
                            photo.comments = photoJSON.getJSONObject("comments").getJSONArray("data").getJSONObject(size-1).getString("text");
                            photo.commentUsername = photoJSON.getJSONObject("comments").getJSONArray("data").getJSONObject(size-1).getJSONObject("from").getString("username");
                        }
